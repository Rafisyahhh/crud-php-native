...
<head>
    ...
    <title>Alamat - Penduduk Desa</title>
...
<body>
                        ...
                        <li class="sidebar-item  has-sub active">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item  active">
                                    <a href="alamat.php" class="submenu-link">Alamat</a>
                                </li>
            ...
            <div class="page-content">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Alamat
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $row['deskripsi'] ?></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning fw-bold" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id_alamat'] ?>">Ubah</button>
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    Swal.fire({
                                                        ...
                                                        if (i.isConfirmed) { 
                                                            window.location.href = "delete.php?id_alamat=<?= $row['id_alamat'] ?>";
                                                        }
                                                    })
                                                }
                                            });
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Tambah Alamat</h4>
                ...
                <form action="create.php" method="post">
                    <div class="modal-body">
                        <label for="alamat">Alamat (RT): </label>
                        <div class="form-group">
                            <input id="alamat" name="alamat" value="<?= isset($_GET['alamat']) ? $_GET['alamat'] : "" ?>" type="text" placeholder="Masukkan Alamat" class="form-control">
                        </div>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
    ?>
        <div class="modal fade text-left" id="editModal<?= $row['id_alamat'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Ubah Alamat</h4>
                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                            <i data-feather="x"></i>
                        </button>
                    </div>
                    <form action="update.php" method="post">
                        <div class="modal-body">
                            <label for="alamat">Alamat (RT): </label>
                            <div class="form-group">
                                <input id="alamat" name="alamat" type="text" placeholder="Masukkan Alamat" value="<?= $row['alamat'] ?>" class="form-control">
                            </div>
                            <label for="deskripsi">Deskripsi: </label>
                            <div class="form-group">
                        ...
                        <input type="hidden" name="id_alamat" value="<?= $row['id_alamat'] ?>">
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                                <i class="bx bx-x d-block d-sm-none"></i>
                                <span class="d-none d-sm-block">Close</span>
