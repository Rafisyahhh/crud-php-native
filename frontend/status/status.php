...
<head>
    ...
    <title>Status - Penduduk Desa</title>
...
<body>
                        ...
                        <li class="sidebar-item  has-sub active">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  active">
                                    <a href="status.php" class="submenu-link">Status</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div class="page-content">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Data Status
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $row['deskripsi'] ?></td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning fw-bold" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id_status'] ?>">Ubah</button>
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    Swal.fire({
                                                        ...
                                                        if (i.isConfirmed) { 
                                                            window.location.href = "delete.php?id_status=<?= $row['id_status'] ?>";
                                                        }
                                                    })
                                                }
                                            });
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Tambah Jenis Status</h4>
                ...
                <form action="create.php" method="post">
                    <div class="modal-body">
                        <label for="alamat">Jenis Status: </label>
                        <div class="form-group">
                            <input id="alamat" name="status_warga" value="<?= isset($_GET['status_warga']) ? $_GET['status_warga'] : "" ?>" type="text" placeholder="Masukkan Jenis Status" class="form-control">
                        </div>
    ...
    while ($row = mysqli_fetch_assoc($result)) {
    ?>
        <div class="modal fade text-left" id="editModal<?= $row['id_status'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="update.php" method="post">
                        <div class="modal-body">
                            <label for="alamat">Jenis Status: </label>
                            <div class="form-group">
                                <input id="alamat" name="status_warga" type="text" placeholder="Masukkan Jenis Status" value="<?= $row['status_warga'] ?>" class="form-control">
                            </div>
                            <label for="deskripsi">Deskripsi: </label>
                            <div class="form-group">
