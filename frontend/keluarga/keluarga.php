...
<head>
    ...
    <title>Keluarga - Penduduk Desa</title>
...
<body>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item active">
                            <a href="keluarga.php" class='sidebar-link'>
                                <i class="bi bi-grid-fill"></i>
                                <span>Keluarga</span>
                            </a>
                        </li>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT * FROM keluarga
                                        INNER JOIN alamat ON keluarga.id_alamat = alamat.id_alamat order by `id_keluarga` asc";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning fw-bold" data-bs-toggle="modal" data-bs-target="#Modal<?= $row['id_keluarga'] ?>">Ubah</button>
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    Swal.fire({
                                                        ...
                                                        if (i.isConfirmed) { 
                                                            window.location.href = "delete.php?id_keluarga=<?= $row['id_keluarga'] ?>";
                                                        }
                                                    })
                                                }
                                            });
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel33">Tambah Data Keluarga</h4>
                ...
                <form action="create.php" method="post">
                    <div class="modal-body">
                        <label for="alamat">Kepala Keluarga: </label>
                        <div class="form-group">
                            <input id="alamat" name="kepala_keluarga" value="<?= isset($_GET['kepala_keluarga']) ? $_GET['kepala_keluarga'] : "" ?>" type="text" placeholder="Masukkan Nama Kepala Keluarga" class="form-control">
                        </div>
                        <label for="deskripsi" class="mt-1">Alamat: </label>
                        <select name="alamat" class="form-select" id="basicSelect">
                            ...
                            foreach ($result as $row) {
                                $selected = ($row['id_alamat'] == $value) ? 'selected' : '';
                                echo '<option value="' . $row['id_alamat'] . '" ' . $selected . '>' . $row['alamat'] . '</option>';
                            };  
                            ?>
                        </select>
                        <label for="deskripsi" class="mt-3">Jumlah Anggota: </label>
                        <div class="form-group">
                            <input id="deskripsi" name="jumlah_anggota" value="<?= isset($_GET['jumlah_anggota']) ? $_GET['jumlah_anggota'] : "" ?>" type="number" placeholder="Masukkan Jumlah Anggota" class="form-control">
                        </div>
                    </div>
    ...
    foreach ($result as $row) {
    ?>
        <div class="modal fade text-left" id="Modal<?= $row['id_keluarga'] ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="update.php" method="post">
                        <div class="modal-body">
                            <label for="alamat">Kepala Keluarga: </label>
                            <div class="form-group">
                                <input id="alamat" name="kepala_keluarga" type="text" placeholder="Masukkan Nama Kepala Keluarga" value="<?= $row['kepala_keluarga'] ?>" class="form-control">
                            </div>
                            <label for="deskripsi" class="mt-1">Alamat: </label>
                            <?php
                            $value = $row['id_alamat'];
                            ...
                            <label for="deskripsi" class="mt-3">Jumlah Anggota: </label>
                            <div class="form-group">
                                <input name="jumlah_anggota" type="number" placeholder="Masukkan Jumlah Anggota" value="<?= $row['jumlah_anggota'] ?>" class="form-control">
                            </div>
                        </div>
                        <input type="hidden" name="id_keluarga" value="<?= $row['id_keluarga'] ?>">
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal">
                                <i class="bx bx-x d-block d-sm-none"></i>
                                <span class="d-none d-sm-block">Close</span>
    ...
    <?php }
    if (isset($_GET['msgangka'])) {
        $msgangka = $_GET['msgangka'];
    ?>
        <script>
            Swal.fire({
                title: "<?= $msgangka ?>",
